    ...
    async getAllMerchant(){
      const responseData = [];
        try{
          ...
          const storeData = await store.readCSVFile('D:/Organization/Repositorys/Kidrovia/backend/file_structure/store/store.csv');
          ...
          try{
            ...
            console.log(`Error fetching advertiser for flexoffer ${apiDataFlexOffer}:`,error.message);
          }
